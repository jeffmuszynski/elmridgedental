...
const supportPages = [
  ...
  },
  {
    ...
    servicePath: '/clear-aligners-killeen-tx',
    ...
    <p>Learn more about <a href="/clear-aligners-killeen-tx">clear aligners in Killeen</a> or return to <a href="/insurance-and-financing">Insurance and Financing</a>.</p>`,
    faq: [
...
function addServiceInsuranceLinks() {
  const snippets = [
    ...
    ['implant-bridge-killeen-tx', '<section class="py-12 bg-white"><div class="max-w-4xl mx-auto px-6 border border-teal-light bg-stone p-7"><h2 class="font-display text-3xl text-charcoal mb-3">Dental Implant Insurance</h2><p class="text-charcoal/65 leading-7 mb-5">Implant coverage varies widely. Learn how benefits, exclusions, annual maximums, and financing may apply.</p><a href="/insurance/implants" class="inline-block bg-teal px-6 py-3 text-center font-body text-xs font-semibold uppercase tracking-widest text-white">Learn About Implant Insurance</a></div></section>'],
    ...
    ['clear-aligners-killeen-tx', '<section class="py-12 bg-white"><div class="max-w-4xl mx-auto px-6 border border-teal-light bg-stone p-7"><h2 class="font-display text-3xl text-charcoal mb-3">Clear Aligner Insurance</h2><p class="text-charcoal/65 leading-7 mb-5">Learn how orthodontic benefits, lifetime maximums, and adult coverage may apply to clear aligners.</p><a href="/insurance/invisalign" class="inline-block bg-teal px-6 py-3 text-center font-body text-xs font-semibold uppercase tracking-widest text-white">Learn About Clear Aligner Insurance</a></div></section>'],
