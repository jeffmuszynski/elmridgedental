...
function buildServicePages() {
  const pages = [
    ...
    makePage({
      ...
      detailSections: [
        { title: 'Gingivitis vs periodontitis', html: '<p>Gingivitis is inflammation at the gumline. It may cause bleeding, redness, swelling, or tenderness, but it has not yet caused the deeper attachment and bone changes seen with periodontitis. Periodontitis is gum disease that reaches deeper around the teeth and can create pockets where bacteria and tartar collect below the gumline.</p>' },
        ...
        { title: 'Why maintenance cleanings are every 3-4 months', html: '<p>After scaling and root planing, periodontal maintenance is usually recommended every 3-4 months because periodontitis is managed over time. These visits help disrupt bacteria before it builds back into deeper pockets, monitor gum stability, and reduce the chance that the disease keeps progressing quietly.</p>' },
