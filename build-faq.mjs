...
const faqSections = [
  ...
  },
  {
    ...
    qas: [
      ...
      ['How much does a routine exam and cleaning cost?', `Call (254) 699-4127 with your insurance information and we'll give you a clear out-of-pocket estimate before your visit. With most PPO insurance, preventive visits are typically covered at or near 100%.`],
      ['How much do dental implants cost in Killeen, TX?', `Single dental implant cost depends on bone condition, whether grafting is needed, the type of final crown, and the overall complexity of the case. We provide a clear written quote after a consultation and CBCT-based planning. Call (254) 699-4127 to schedule.`],
      ['How much do clear aligners cost?', `Clear aligner treatment cost varies with case complexity and treatment length. Many dental insurance plans contribute toward orthodontic care, and we offer monthly payment plans through CareCredit. Call (254) 699-4127 with your insurance information and we'll provide a clear treatment quote and payment options.`],
  ...
  },
  {
    ...
    qas: [
      ...
      ['How long do clear aligners take?', `Most adult cases finish in 12-18 months. Mild cases can wrap up in as little as 6 months; complex cases may take 24+ months. You'll wear each aligner about 1-2 weeks before switching to the next.`],
      ['Clear aligners or braces - which is better?', `Both straighten teeth effectively. Clear aligners are removable, easier for eating and hygiene, nearly invisible, and work for many cases. Traditional braces are sometimes better for severe rotations, large gaps, or complex bite issues. We'll tell you honestly which is right for your case.`],
      ...
      ['How does professional teeth whitening work?', `Elm Ridge uses custom take-home whitening trays with professional whitening gel. The trays help the gel reach the teeth evenly while giving you a controlled way to brighten your smile at home.`],
...
const firstLinkRules = [
  ...
  { key: 'clear aligners', regex: /\bclear aligners\b/i, href: '/clear-aligners-killeen-tx' },
