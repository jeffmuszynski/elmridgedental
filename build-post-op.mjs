...
function painControlBlock() {
  return `<aside class="mt-8 border border-teal-light bg-teal-pale/60 p-6 sm:p-7">
    <img src="/assets/images/tylenol-ibuprofen-schedule.png" alt="Alternating Tylenol and Ibuprofen schedule for post-operative dental pain control" class="mx-auto w-full max-w-[390px] h-auto object-contain" loading="lazy" decoding="async" width="379" height="312" />
...
function addServicePostOpLinks() {
  const snippets = [
    ...
    ['implant-bridge-killeen-tx', '<section class="py-12 bg-stone"><div class="max-w-4xl mx-auto px-6 border border-teal-light bg-white p-7"><h2 class="font-display text-3xl text-charcoal mb-3">After Implant Treatment</h2><p class="text-charcoal/65 leading-7 mb-5">Review healing instructions for dental implant surgery and bone grafting before or after your appointment.</p><div class="flex flex-col sm:flex-row gap-3"><a href="/post-operative-instructions#implants" class="inline-block bg-teal px-6 py-3 text-center font-body text-xs font-semibold uppercase tracking-widest text-white">Dental Implant Instructions</a><a href="/post-operative-instructions#bone-graft" class="inline-block border border-teal px-6 py-3 text-center font-body text-xs font-semibold uppercase tracking-widest text-teal-dark">Bone Graft Instructions</a></div></div></section>'],
